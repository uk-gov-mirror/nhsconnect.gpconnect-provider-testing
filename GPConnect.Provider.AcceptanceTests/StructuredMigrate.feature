...
#Removing this test as it's not consistent with TestSuitePrerequisites spreadsheet. 
#Also test "Structured Migrate request for Patient2 Excluding Sensitive Data expect success" does the same check. 
